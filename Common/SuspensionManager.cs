...
namespace Cloudsdale.Common {
    ...
    internal sealed class SuspensionManager {
        ...
        private static readonly List<Type> MKnownTypes = new List<Type>();
        ...
        public static async Task SaveAsync() {
            ...
            DataContractSerializer serializer = new DataContractSerializer(typeof(Dictionary<string, object>), MKnownTypes);
